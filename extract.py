    ...
    def btn_click(xpath):
        try:
            ...
            driver.execute_script("arguments[0].click();", WebDriverWait(
                driver, 3, _sleep, ignored_exceptions=ignored_exceptions).until(
    ...
    while 1:
        ...
        try:
            ...
            for i in range(1, 10):
                ...
                if "Super" in _type or "Rare" in _type or "Legendary" in _type:
                    COST = COST*1.25
                    STAMP = 0
                ...
                if _price <= COST:
                    ...
                    _xpath_btn_close_modal = '//*[@id="confirm-buy-car"]/div/div/div/button'
                    ...
                    try:
                        ...
                        take_screenshot(WebDriverWait(driver, 5, _sleep, ignored_exceptions=ignored_exceptions) \
                            .until(EC.visibility_of_element_located((By.XPATH, _xpath_img_captcha))), driver,
                                        f"{_loop[0]}.png")
                    ...
                    btn_click(_xpath_btn_close_modal)
                    time.sleep(1)
            ...
            # _loop[4] = uniform(1.5, 5)
            # print(f'\r i: {_loop[0]} \t _type: {_loop[1]} \t _level: {_loop[2]} \t _price: {_loop[3]} \t zzz: {_loop[4]}', end="")
            # time.sleep(_loop[4])
